    ...
    public class TweetListViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
            Tweets = new ObservableCollection<Tweet>
                         {
                             {new Tweet{ User = new User{ Screen_Name = "Jaime"}, Text = "I'm making a twitter client... no kidding...."}},
                             {new Tweet{ User = new User{ Screen_Name = "JohnDoe"}, Text = "Really? you're so cool..."}},
                             {new Tweet{ User = new User{ Screen_Name = "JaneDoe"}, Text = "Really? Cause there are not enough twitter clients out there already..."}}
                         };
        }
    }
}